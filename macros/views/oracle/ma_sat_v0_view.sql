{%- macro oracle__ma_sat_v0_view(parent_hashkey, src_hashdiff, src_ma_key, src_payload, src_ldts, src_rsrc, source_model) -%}
...
{# Get the latest record for each parent hashkey in existing sat. #}
